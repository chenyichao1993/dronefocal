        ...
        {relatedArticles.map(article => (
          <Link key={article.slug} href={`/drone-reviews/${article.slug}`}>
            <div className="related-article-card group">
              <div className="flex items-start space-x-3 p-4 border border-gray-200 dark:border-gray-700 rounded-lg hover:border-blue-500 hover:shadow-md transition-all duration-300">
                <div className="flex-shrink-0">
                  <Image
                    ...
                    width={80}
                    height={60}
                    className="related-article-thumbnail w-20 h-15 object-cover rounded-md"
                  />
                </div>
                <div className="flex-1 min-w-0">
                  <h4 className="related-article-title text-sm font-medium text-gray-900 dark:text-white group-hover:text-blue-600 dark:group-hover:text-blue-400 transition-colors line-clamp-2 mb-1">
                    {article.title}
                  </h4>
